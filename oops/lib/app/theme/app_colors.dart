...
class AppColors {
  ...
  static const Color cardShadow     = Color(0x0A0F172A); // 4% black
  ...
  // Tinted surfaces for badges, chips, and banners
  static const Color primarySurface   = Color(0xFFEFF6FF); // Blue 50
  static const Color secondarySurface = Color(0xFFD1FAE5); // Emerald 100
